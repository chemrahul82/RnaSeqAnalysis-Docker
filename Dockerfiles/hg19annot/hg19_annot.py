...
"""
wrapper script for docker container that copies hg19 annotation files to the host directory inside RNASEQ analysis workflow
"""
...
if __name__ == "__main__":
    ...
    shutil.copy('hg19.fasta',annotDir)